...
define([], function() {
    ...
    betweenDaysRequirement: 'Between {{minQuantity}} and {{maxQuantity}} days',
    signUpTitle: 'Sign up',
    ...
    noFilter: 'No filter',
    costRangeRequirement: 'Min value must be lower than max value',
    ...
    oldestOrder: 'Oldest',
    newestOrder: 'Newest',
    costAscendingOrder: 'Funding target ascending',
    costDescendingOrder: 'Funding target descending',
    percentageAscendingOrder: '% Funded ascending',
    percentageDescendingOrder: '% Funded descending',
    ...
    lastName: 'Last Name',
    realId: 'Identification',
    dealsTitle: 'Accepted Deals',
    msgTitleBody: 'Message',
    msgTitleOffer: 'Offer',
    msgTitleRequest: 'In exchange',
    noDeals: 'No deals done yet',
    reqTitle: 'My Investments',
    pending: 'Pending',
    accepted: 'Accepted',
    rejected: 'Rejected',
    myProjects: 'My Projects',
    showAccProj: 'Paused projects',
    showCurrProj: 'Published projects',
    ...
    createProjectSubtitle: 'Remember to complete as many fields as you can. The more concise you are, the more chances you will have to  connect with a potential investor. You can add project stages once you finished creating it.',
    ...
    projectSummaryPlaceholder: 'Describe your project in less than {{maxLength}} characters',
    ...
    clicksAvg: 'Avg. clicks on screen',
    minutesAvg: 'Avg. minutes on screen',
    miutes: 'minutes',
    daysAgo: 'Days Ago',
    outof: 'out of',
    seen: 'Visits',
    contactClicks: 'Times reached out',
    investorsSeen: 'Investor visits',
    lastSeen: 'Last visit',
    ...
    pageTitleNewProject: 'New Project | VestNet',
    pageTitleFeed: 'Home | VestNet',
    pageTitleRequestPassword: 'Request Password | VestNet',
    pageTitleMyMessages: 'My Messages | VestNet',
    pageTitleMyInvestments: 'My Investments | VestNet',
