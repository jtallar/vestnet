    ...
    return {
      ...
      template: function(element, attrs) {
          return '<ul class="pagination justify-content-center">\n' +
            ...
            '          <a id="li-a-previous" class="page-link" ng-click="getToPage(1)" aria-label="{{\'previousPage\' | translate}}">\n' +
            ...
            '          <a id="li-a-previous-num" class="page-link" ng-click="getToPage(page - 2)" aria-label="{{\'pageNumber\' | translate : {p: page - 1} }}">\n' +
            '            {{page -2}}\n' +
            '          </a>\n' +
            '        </li>\n' +
            '      </div>\n' +
            ...
            '        <li id="li-next-num" class="page-item">\n' +
            '          <a id="li-a-next-num" class="page-link" ng-click="getToPage(page + 2)" aria-label="{{\'pageNumber\' | translate : {p: page + 2} }}">{{page + 2}}</a>\n' +
            '        </li>\n' +
            '      </div>\n' +
            '      <div ng-if="(page + 1) <= lastPage">\n' +
            ...
            '        <li id="li-next" class="page-item">\n' +
            '          <a id="li-a-next" class="page-link" ng-click="getToPage(lastPage)"  aria-label="{{\'nextPage\' | translate}}">\n' +
