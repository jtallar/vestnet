...
public class RangeCheckValidtor implements ConstraintValidator<RangeCheck, ProjectFilterForm> {
    ...
    @Override
    public boolean isValid(ProjectFilterForm dto, ConstraintValidatorContext constraintValidatorContext) {
