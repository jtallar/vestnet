...
public class ImageValidator implements ConstraintValidator<ImageFile, MultipartFile> {
    private static final String ERROR_FILE_TYPE = "{ar.edu.itba.paw.webapp.forms.ImageValidator.image.type}";
    private static final String ERROR_FILE_SIZE = "{ar.edu.itba.paw.webapp.forms.ImageValidator.image.size}";
