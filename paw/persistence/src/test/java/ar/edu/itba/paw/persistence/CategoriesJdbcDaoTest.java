...
public class CategoriesJdbcDaoTest {
    ...
    @Autowired
    private CategoriesJpaDao categoriesJpaDao;
    ...
    public void testFindAllIfTableEmpty() {
        ...
        // 2 - Execute
        List<Category> categories = categoriesJpaDao.findAll();
    ...
    public void testFindAllIfTableNotEmpty() {
        ...
        assertNull(categories.get(0).getParent());
    }
...
//
//        // 2 - Execute
//        List<Category> categories = categoriesJpaDao.findProjectCategories(1);
//
//        // 3 - Assert
//        assertTrue(categories.isEmpty());
//    }
...
//        createProjectCategory(CATEGORY_ID, projectId);
//
//        // 2 - Execute
//        List<Category> categories = categoriesJpaDao.findProjectCategories(projectId.longValue());
//
...
//    }
    ...
    public void createCategory() {
        ...
        jdbcInsertCategory.execute(category);
    }
